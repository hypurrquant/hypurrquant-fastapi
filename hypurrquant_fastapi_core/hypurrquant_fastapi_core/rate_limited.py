...
class AsyncRateLimiter:
    def __init__(self, max_quota: float = 1200, window_sec: int = 60):
    ...
    async def record(self, weight: float = 1) -> float:
        """
...
def hl_rate_limited(
    weight: float = 1, limiter: AsyncRateLimiter = _default_async_limiter
):
    """
